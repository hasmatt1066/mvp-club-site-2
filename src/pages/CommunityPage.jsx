...
const CommunityPage = () => {
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--color-background)', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-4" style={{ backgroundColor: 'var(--color-background)' }}>
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="font-display text-4xl md:text-5xl mb-4" style={{ color: 'var(--color-primary)' }}>
      ...
      <section className="pt-14 pb-16" style={{ backgroundColor: 'white' }}>
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="card-hover bg-white border border-gray-100 p-8 rounded-2xl h-full">
                <div
      ...
      <section className="py-14" style={{ backgroundColor: 'var(--color-background)' }}>
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="font-display text-3xl md:text-4xl mb-8 text-center" style={{ color: 'var(--color-primary)' }}>
